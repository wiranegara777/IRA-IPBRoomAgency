<?php 
    ...
    if(isset($_POST['submit'])) {
        ...
        $query = "SELECT * FROM room where title like '%$name%'";
...
<title>Search <?php echo $name; ?></title>
                ...
                <ul id="sortable">
                    <?php for($x = 0; $x < count($a); $x++) {  
                     ...
                     <li><div class="media">
                            <div class="media-body">
                                <h4> <?php echo $a[$x]->getTitle(); ?> </h4>
                            </div>
                            <div class="media-right align-self-center">
                                <a href="baru.php?id=<?php echo $a[$x]->getId_room(); ?>" class="btn btn-default">Lihat Detail</a>
                            </div>
                    ...
                    <?php } ?>
                     ...
                     <?php if($result->num_rows <= 0)
                          echo "<center><h4> Ruangan tidak ditemukan </h4></center>"; ?>
                </ul>
