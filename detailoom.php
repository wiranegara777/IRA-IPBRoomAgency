    ...
    <div class="col-sm">
      ...
      <div style="margin-left: 2cm">
        <h5><dt>Detail Ruangan:</dt></h5>
				<p><b>Deskripsi</b> : <?php echo $room->getBody(); ?> </p>
        <dd><b>Lokasi </b>      : <?php echo $room->getAddress(); ?></dd>
        <dd><b> Kapasitas </b>  :<?php echo $room->getKapasitas(); ?> orang.</dd>
        <dd><b> Fasilitas </b>  : <?php echo $room->getFasilitas(); ?></dd>
